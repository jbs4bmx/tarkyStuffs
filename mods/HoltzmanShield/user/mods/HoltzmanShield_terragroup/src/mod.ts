...
class Holtzman implements IMod
{
    ...
    public delayedLoad(container: DependencyContainer): void
    {
        ...
        logger.info("Holtzman Shield TG Mod Loading...");
        ...
        var itemPrefabPath = "assets/content/items/equipment/armband/item_equipment_armband_terragroup.bundle";
        var itemLongName = "Holtzman Shield (TerraGroup)";
        var itemShortName = "HSTG";
        ...
        if (typeof MainArmor.Head === "boolean") {
            ...
            armor.push("Head")
            logger.warning(`[HSTG Mod] - Resource value Head is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.Thorax === "boolean") {
            ...
            armor.push("Chest")
            logger.warning(`[HSTG Mod] - Resource value Chest is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.Stomach === "boolean") {
            ...
            armor.push("Stomach")
            logger.warning(`[HSTG Mod] - Resource value Stomach is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.LeftArm === "boolean") {
            ...
            armor.push("LeftArm")
            logger.warning(`[HSTG Mod] - Resource value LeftArm is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.RightArm === "boolean") {
            ...
            armor.push("RightArm")
            logger.warning(`[HSTG Mod] - Resource value RightArm is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.LeftLeg === "boolean") {
            ...
            armor.push("LeftLeg")
            logger.warning(`[HSTG Mod] - Resource value LeftLeg is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.RightLeg === "boolean") {
            ...
            armor.push("RightLeg")
            logger.warning(`[HSTG Mod] - Resource value RightLeg is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        ...
        if (typeof HeadAreas.Top === "boolean") {
            ...
            segments.push("Top")
            logger.warning(`[HSTG Mod] - Resource value Top is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Nape === "boolean") {
            ...
            segments.push("Nape")
            logger.warning(`[HSTG Mod] - Resource value Nape is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Ears === "boolean") {
            ...
            segments.push("Ears")
            logger.warning(`[HSTG Mod] - Resource value Ears is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Eyes === "boolean") {
            ...
            segments.push("Eyes")
            logger.warning(`[HSTG Mod] - Resource value Eyes is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Jaws === "boolean") {
            ...
            segments.push("Jaws")
            logger.warning(`[HSTG Mod] - Resource value Jaws is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        ...
        if (typeof Resources.RepairCost === "number") {
            ...
            logger.warning(`[HSTG Mod] - Resource value RepairCost is not a number.`, "yellow", "red");
        }
        if (typeof Resources.Durability === "number") {
            ...
            logger.warning(`[HSTG Mod] - Resource value Durability is not a number.`, "yellow", "red");
        }
        if (typeof Resources.minTraderLevel === "number") {
            ...
            logger.warning(`[HSTG Mod] - Resource value minTraderLevel is not a number.`, "yellow", "red");
        }
        if (typeof Resources.marketPrice === "number") {
            ...
            logger.warning(`[HSTG Mod] - Resource value marketPrice is not a number.`, "yellow", "red");
        }
        if (typeof Resources.traderPrice === "number") {
            ...
            logger.warning(`[HSTG Mod] - Resource value traderPrice is not a number.`, "yellow", "red");
        }
		...
		placeable._props.filters[0].Filter.push("HShieldTG");

        logger.info("Holtzman Shield TG Mod: Cached Successfully");
    }
