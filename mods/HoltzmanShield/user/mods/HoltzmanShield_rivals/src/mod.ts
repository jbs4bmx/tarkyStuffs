...
class Holtzman implements IMod
{
    ...
    public delayedLoad(container: DependencyContainer): void
    {
        ...
        logger.info("Holtzman Shield Rivals Mod Loading...");
        ...
        var itemPrefabPath = "assets/content/items/equipment/armband/item_equipment_armband_revals.bundle";
        var itemLongName = "Holtzman Shield (Rivals)";
        var itemShortName = "HSRI";
        ...
        if (typeof MainArmor.Head === "boolean") {
            ...
            armor.push("Head")
            logger.warning(`[HSRI Mod] - Resource value Head is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.Thorax === "boolean") {
            ...
            armor.push("Chest")
            logger.warning(`[HSRI Mod] - Resource value Chest is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.Stomach === "boolean") {
            ...
            armor.push("Stomach")
            logger.warning(`[HSRI Mod] - Resource value Stomach is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.LeftArm === "boolean") {
            ...
            armor.push("LeftArm")
            logger.warning(`[HSRI Mod] - Resource value LeftArm is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.RightArm === "boolean") {
            ...
            armor.push("RightArm")
            logger.warning(`[HSRI Mod] - Resource value RightArm is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.LeftLeg === "boolean") {
            ...
            armor.push("LeftLeg")
            logger.warning(`[HSRI Mod] - Resource value LeftLeg is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof MainArmor.RightLeg === "boolean") {
            ...
            armor.push("RightLeg")
            logger.warning(`[HSRI Mod] - Resource value RightLeg is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        ...
        if (typeof HeadAreas.Top === "boolean") {
            ...
            segments.push("Top")
            logger.warning(`[HSRI Mod] - Resource value Top is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Nape === "boolean") {
            ...
            segments.push("Nape")
            logger.warning(`[HSRI Mod] - Resource value Nape is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Ears === "boolean") {
            ...
            segments.push("Ears")
            logger.warning(`[HSRI Mod] - Resource value Ears is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Eyes === "boolean") {
            ...
            segments.push("Eyes")
            logger.warning(`[HSRI Mod] - Resource value Eyes is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        if (typeof HeadAreas.Jaws === "boolean") {
            ...
            segments.push("Jaws")
            logger.warning(`[HSRI Mod] - Resource value Jaws is not a boolean. Defaulting to true.`, "yellow", "red");
        }
        ...
        if (typeof Resources.RepairCost === "number") {
            ...
            logger.warning(`[HSRI Mod] - Resource value RepairCost is not a number.`, "yellow", "red");
        }
        if (typeof Resources.Durability === "number") {
            ...
            logger.warning(`[HSRI Mod] - Resource value Durability is not a number.`, "yellow", "red");
        }
        if (typeof Resources.minTraderLevel === "number") {
            ...
            logger.warning(`[HSRI Mod] - Resource value minTraderLevel is not a number.`, "yellow", "red");
        }
        if (typeof Resources.marketPrice === "number") {
            ...
            logger.warning(`[HSRI Mod] - Resource value marketPrice is not a number.`, "yellow", "red");
        }
        if (typeof Resources.traderPrice === "number") {
            ...
            logger.warning(`[HSRI Mod] - Resource value traderPrice is not a number.`, "yellow", "red");
        }
		...
		placeable._props.filters[0].Filter.push("HShieldRivals");

        logger.info("Holtzman Shield Rivals Mod: Cached Successfully");
    }
