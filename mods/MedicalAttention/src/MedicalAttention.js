/*
    ...
    Aki Version: >=2.2.0
	--- --- --- ---
	Description: Modifications to medical supplies based on properties in the configuration file.
	Copyright: jbs4bmx
...
class medAttn
{
	...
	constructor()
	{
		this.mod = "MedicalAttention v2.3.1";
	...
	*/
	...
	load()
    {
		Logger.info("Loading: Medical Attention v2.3.1");
...
module.exports = { mod: new medAttn() }